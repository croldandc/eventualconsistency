...
\newcommandx{\arro}[2][2=i]{\xrightarrow[]{#1}_{#2}}
...
\newcommand{\tupdins}{{\tt update} (u)}

\newcommand{\tpushins}{{\tt push};P}
\newcommand{\tconfirmedins}[1]{{\tt let}\ #1 = {\tt confirmed};P}

\newcommandx{\twhile}[3][3=P]{{\tt while} (#1)\ {\tt do}\ #2 \ {\tt od}; #3}
\newcommandx{\tifte}[4][1=\cond,2=P,3=P,4=P]{{\tt if} (#1)\ {\tt then}\ #2 \ {\tt else}\ #3 \ {\tt fi}; #4}
