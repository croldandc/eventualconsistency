...
\newcommandx{\tclient}[8][7=\cid,8=n,usedefault=@]{\langle #1 , #4, #5, #3,  #2, #6, #8\, \rangle_{#7}}
\newcommandx{\tclienti}[8][7=\cid,8=n,usedefault=@]{{\tclient{#1}{#2}{#3}{#4}{#5}{#6}[#7][#8]}}
...
\newcommandx{\aread}[1][1={}]{\textcolor{OliveGreen}{\textit{r#1}}}
