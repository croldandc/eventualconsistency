...
\newcommandx{\tclient}[8][7=\cid,8=\trounds,usedefault=@]{\langle #1 , #4, #5, #3,  #2, #6\, \rangle_{#7}}
...
\newcommandx{\ublock}[2][1=\ttransactionbuffer,2=\cid]{\textcolor{Gray}{\llparenthesis#1\rrparenthesis}}
...
\newcommand{\tsenthead}[1][]{\textcolor{Gray}{\llparenthesis\ttransactionbuffer[']#1\rrparenthesis}}
...
\newcommandx{\aseg}[2][1={},2=seg,usedefault=@]{\textcolor{Brown}{\mathit{#2#1}}}
\newcommandx{\aseqseg}[2][1={},2=seg,usedefault=@]{\textcolor{Brown}{\mathtt{#2#1}}}
...
\newcommandx{\around}[2][1={},2=r,usedefault=@]{\textcolor{Brown}{\mathit{#2#1}}}
\newcommandx{\aseqround}[2][1={},2=r,usedefault=@]{\textcolor{Brown}{\mathtt{#2#1}}}
...
\newcommand{\refiwellformprop}[1]{\defref{def:wf-igsp}, Prop. \ref{#1}}
\newcommand{\refwellformprop}[1]{\defref{def:wf-gsp}, Prop. \ref{#1}}
