...
\newcommandx{\pendingtype}[1][1={},usedefault=@]{\textcolor{Brown}{\adeltaseq{#1}}}
...
\newcommandx{\abstsyst}[4][1=j,2=J,3=\Absclient_j, 4=\queuemessage,usedefault=@]{\paralelo{#1}{#2}{#3}{#4}}

\newcommandx{\abstcliJ}[1][1=j]{\tclienti{\tprogram_{#1}}{\tknown_{#1}}{\tpending_{#1}}{\ttransactionbuffer_{#1}}{\tsent_{#1}}{\treceivebuffer_{#1}}[{\cid_{#1}}]}


\newcommandx{\concsyst}[4][1=j,2=J,3={\addid{\iclientsyntax}[\cid_j]}
, 4=\iserver,usedefault=@]{\paralelo{#1}{#2}{#3}{#4}}
