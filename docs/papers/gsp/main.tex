...
such language to be equipped with a valuation function, written $\eval{\_}$, which associates expressions 
with values.  
A program $\plet{x}{\ldots}{P}$ introduces a bound variable whose  scope is $P$. The definition of 
free variables of a programs is  standard. We say that process $P$ is {\em closed} when it has 
no free variables.
...
\mathrule{t-read}
  	{\rvalue{r}
 		{\flatten(\queuemessage[0..\tknown-1] \cdot \tpending) \cdot \ttransactionbuffer} = v}		
	{\tsystem{\tclienti{\treadins{x}{r}}{\tknown}{\tpending}{\ttransactionbuffer}{\tsent}{\treceivebuffer}\ \bigpar\ C}
			{\queuemessage} \arro{\readtran{r}} \tsystem{\tclienti{\update{\tprogram}{x}{v}}{\tknown}
			{\tpending}{\ttransactionbuffer}{\tsent}{\treceivebuffer}\bigpar\ C}{\queuemessage}}
\\[25pt]
...
\mathrule{t-while-true}{\condition{\cond}{false}}{\tsystem{\tclienti{\pwhile{\cond}{\tprogram}}{\tknown}{\tpending}{\ttransactionbuffer}{\tsent}{\treceivebuffer} \bigpar \system}{\queuemessage} \arro{\tau} \tsystem{\tclienti{\tprogram;\pwhile{\cond}{\tprogram}}{\tknown}{\tpending}{\ttransactionbuffer}{\tsent}{\treceivebuffer+1} \bigpar\ \system}{\queuemessage}}


\\[25pt]

\mathrule{t-while-false}{\condition{\cond}{true}}{\tsystem{\tclienti{\pwhile{\cond}{\tprogram;Q}}{\tknown}{\tpending}{\ttransactionbuffer}{\tsent}{\treceivebuffer} \bigpar \system}{\queuemessage} \arro{\tau} \tsystem{\tclienti{Q}{\tknown}{\tpending}{\ttransactionbuffer}{\tsent}{\treceivebuffer+1} \bigpar\ \system}{\queuemessage}}
