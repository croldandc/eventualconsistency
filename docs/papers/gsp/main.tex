...
We have introduced an abstract GSP protocol and a robust streaming server-client implementation of GSP. Next theorem states one of most important result of the paper, saying that they are weak bisimulation equivalent. 
