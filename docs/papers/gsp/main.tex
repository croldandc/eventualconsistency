...
\newcommand{\updatetran}{\textit{update}(u)}
...
\[ 
\begin{array}{r@{\ ::= \ }l}
  \alpha & \tau \ | \ \readtran{r} \ | \  \updatetran \ | \ \pulltran \ | \ \pushtran \ | \ \confirmedtran 
\end{array}
\]
...
\mathax{t-update}{\tsystem{\tclienti{\tupdateins}{\tknown}{\tpending}{\ttransactionbuffer}{\tsent}{\treceivebuffer}\ \bigpar\ C}{\queuemessage} \arro{\updatetran} \tsystem{\tclienti{\tprogram}{\tknown}{\tpending}{\ttransactionbuffer\ \cdot \tupdate}{\tsent}{\treceivebuffer}\ \bigpar\ C}{\queuemessage}}
...
\\[25pt]
		...
		\mathax{update}{\clientr{\updateins{u}}{\stateclient} \arro{\updatetran} \clientr{P}{\update{E}{\transactionbuffer}{\appendplus{E.\transactionbuffer}{u}}}} \\[15pt]
...
dom(\op)}{\enviroment{\systemterm}{\op}{\so}{\vis}{\arb} \arroi{\updatevtran{u}{v}} \enviroment{\systemterm'}{\op \ \cup \ \{v \mapsto \updatetran \}}{\soby{\so}{v}}{\vis}{\arb}}
...
E = \enviroment{C_1\ \bigpar\ C_2 \bigpar\ S}{\emptyset}{\emptyset}{\emptyset}{\emptyset} 
\\
\\
C_1 = \tclient{\textit{add(aList,'hello');push();send();}}{0}{\epsilon}{\epsilon}{\epsilon}{\epsilon}
\\
C_2 = \tclient{\textit{add(aList,'world');push();send();let v = read(x);}}{0}{\epsilon}{\epsilon}{\epsilon}{\epsilon} 
\\
S = \epsilon 
\end{array}
\]
...
Enviroment has a system $\systemterm$ with two clients and a message queue $S$ without updates. Relation sets $\op$,$\so$,$\vis$,$\arb$ are empty, i.e.,there were not an execution in $\systemterm$ captured by the relation sets. The update action add a string to an object called $aList$. 
In this state, $C_1$ and $C_2$ can perform their update actions. Considerer the following execution:

\[
\begin{array}{l}
  E  \arrobyclient{\updatevtran{add(aList,'hello')}{v}}{1} \enviroment{C'_1\ \bigpar\ C_2 \bigpar\ S}{v_0 \mapsto add(aList,'hello')}{\emptyset}{\emptyset}{\emptyset} \\
\\
\\
C'_1 = \tclient{push();send();}{0}{\epsilon}{\epsilon}{\epsilon}{\epsilon}
\\
C_2 = \tclient{\textit{update(aList,'world');push();send();let v = read(x);}}{0}{\epsilon}{\epsilon}{\epsilon}{\epsilon} 
\\
S = \epsilon 
\end{array}
\]
