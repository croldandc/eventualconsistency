...
\begin{enumerate}
	...
	\item $\astate_l \triangleleft \queuemessage[0 .. \tknown_l - 1]$
	\item $\pending_l = \aroundtuplei[0]\ldots\aroundtuplei[h]$ and $\adelta_0\cdots\adelta_h\cdot {\pushbuffer}_l \triangleleft \tpending_l$
	\item $\length{\inclient}_l = \treceivebuffer_l$ and for all $0 \leq h < \treceivebuffer_l$,  $\inclient[h] = \agssegpair$ and $\adelta\triangleleft{\queuemessage[\tknown + l]}$
