...
Consider the following system consisting of two clients and the empty store: 
different client:

\[
\begin{array}{lll}
   \Absclient[_1] & = & {\anabstcli[{}][{\updcmd[{\anupd_1}];\pushcmd;P}][\epsilon][\epsilon][\epsilon][0][0]}_{1}\\
   \Absclient[_2] & = & {\anabstcli[{}][{\updcmd[{\anupd_2}];\pushcmd;Q}][\epsilon][\epsilon][\epsilon][0][0]}_{2}\\
\end{array}
\]
\[
\begin{array}{l}
