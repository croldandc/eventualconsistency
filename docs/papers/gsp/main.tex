...
We now comment on the inference rules in \figref{fig:OS-tgsp} defining the operational semantics of \tgspcalculus.
When a client performs an update $u$ (rule \textsc{update}), the change is made locally by extending the local sequence of updates $\alpha$
