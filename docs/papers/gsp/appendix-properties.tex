...
case analysis on the rule applied for the last transition:
 ...
 $,then,  there is not $\anupd_0$ s.t.
       ...
       \item $(\vertice,\vertice[y]) \in \{(\vertice[@][_i],\vertice[@][_j]) \ |\ \vertice[@][_i],\vertice[@][_j]\in \{\vertice[@][_0],\ldots,\vertice[@][_n]\}, i<j\ $ follow immediately by \lemref{lemma:upd-in-buffers-updinSO}.
        \end{itemize}
