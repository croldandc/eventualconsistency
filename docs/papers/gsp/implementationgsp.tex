...
\item $\pending_l = \aroundtuplei[0]\cdots\aroundtuplei[r]$,  $\irounds_j < \irounds_k$ for all  ${ j}\leq{k}$ and either.
	\begin{itemize}
		\item $\pushbuffer_l =\emptydelta$ and $\irounds_r \leq \irounds_l$; or
		\item $\pushbuffer_l \neq \emptydelta$ and $\irounds_r < \irounds_l$;
	\end{itemize}
