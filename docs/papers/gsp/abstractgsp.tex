...
$\Absclient_l = \tclienti{\tprogram_l}{\tknown_l}{\tpending_l}{\ttransactionbuffer_l}{\tsent_l}{\treceivebuffer_l}[\cid_l][n_l]$ 
for all $0\leq l \leq n$  is {\em well-formed} if it 
...
\mathrule{confirm}
 %	{\eval{(\tpending \cdot  \ttransactionbuffer == \epsilon)}  v}
	{v = {(\tpending \cdot  \ttransactionbuffer == \epsilon)}}
	{
