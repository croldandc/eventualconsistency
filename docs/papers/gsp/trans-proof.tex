...
case analysis on the inference rule applied for the last transition:
	...
	\begin{itemize}
        ...
        implies $\anupd{\vertice[w]} \in \queuemessage[0..\tknown-1]$. Then, if  $(\vertice[w],\vertice[w']) \in \arb, by \lemref{lemma:vertice_arb_store}, \vertice[w'] \in \queuemessage[0..\tknown-1]$.
