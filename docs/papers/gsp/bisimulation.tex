		...
		\ \bigpar\ \iclient[''] \\
				...
				by checking the properties in \defref{def:implementation}.			
						...
						\begin{itemize}
							...
							\item[\ref{prop_sent}.] We have moved the ${\pushbuffer}$ to $\inserver(\cid)$, leaving in the push buffer, $\emptydelta$. Furthermore, ${\tsent}_t$ is $\epsilon$. By \triangemptydelta this part of the property holds. 	
