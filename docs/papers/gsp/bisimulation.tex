...
\begin{enumerate}
	...
	\item \label{prop_send} If $\cid \in \inserver \ \land \  \cid \in \outserver \ $then $(\tsent_l$ = ${\tsent}_h \cdot {\tsent}_t \ \land \ {\pushbuffer}_l \ \triangleleft \ {\tsent}_t \ \land \ \ireduce{\igetdeltas{\inserver(l)}} \triangleleft \ {\tsent}_h) \ $
